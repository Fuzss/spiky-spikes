            ...
            submitNodeCollector.order(1)
                    .submitCustomGeometry(poseStack,
                            ...
                            (PoseStack.Pose pose, VertexConsumer vertexConsumer) -> {
                                this.renderSpike(pose, vertexConsumer, state.blockModel, state.lightCoords);
                            });
                        ...
                        .submitCustomGeometry(poseStack,
                                ...
                                (PoseStack.Pose pose, VertexConsumer vertexConsumer) -> {
                                    VertexConsumer textureGenerator = new SheetedDecalTextureGenerator(vertexConsumer,
                                            ...
                                            1.0F);
                                    this.renderSpike(pose, textureGenerator, state.blockModel, state.lightCoords);
                                });
            }
        }
    }

    private void renderSpike(PoseStack.Pose pose, VertexConsumer buffer, BlockModelRenderState blockModel, int lightCoords) {
